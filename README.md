...
- **[grc risk register](grc-risk-register/GRC_Risk_Register.xlsx)**  A self-built risk register and control mapping tool spreadsheet, covering asset inventory, a Likelihood x Impact risk scoring model, and a control register mapped to all 93 ISO/IEC 27001:2022 Annex A controls via live lookups. Built from scratch rather than using an off the shelf GRC platform, to demonstrate the underlying structure (asset -> risk -> control) rather than just tool proficiency.
